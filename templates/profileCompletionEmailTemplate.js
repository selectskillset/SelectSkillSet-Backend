export const generateCompleteEmail = (firstName) => {
      ...
      <html>
        ...
        <body>
          <div class="container">
            ...
            <a href="https://yourwebsite.com/dashboard" class="button">View Your Profile</a>
            <div class="footer">
              <p>If you have any questions, feel free to contact us at <a href="mailto:support@yourwebsite.com" style="color: #0077B5;">support@yourwebsite.com</a>.</p>
            </div>
          </div>
        </body>
      </html>
  ...
  export const generateIncompleteEmail = (firstName, totalPercentage, missingSections) => {
    // Ensure missing sections are strings
    const formattedMissingSections = missingSections.map((section) => typeof section === "string" ? section : JSON.stringify(section));
  
    const missingSectionsList = formattedMissingSections
      ...
      <html>
        ...
        <body>
          <div class="container">
            ...
            <h1>🌟 Hi, ${firstName}! 🌟</h1>
            <p>Your profile is currently ${totalPercentage}% complete.</p>
            <p>To ensure your profile reflects your full potential, please complete the following sections:</p>
            <ul>
              ${missingSectionsList}
            </ul>
            <a href="https://yourwebsite.com/profile/edit" class="button">Complete Your Profile</a>
            <div class="footer">
